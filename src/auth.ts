...
export const signup = async (username: string, password: string, password_confirmation: string) => {
...
export const login = async (username: string, password: string, password_confirmation: string) => {
  const result = await httpApi(
    "user/signin",
    {
      username,
