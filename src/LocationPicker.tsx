      ...
      <div className="relative mt-2">
        <ListboxButton className="relative w-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6">
          <span className="inline-flex w-full truncate">
            ...
            <span className="ml-2 truncate text-gray-500">{selected.proxiesCount}</span>
          </span>
        ...
        >
          {availableCountries.map((country) => (
            ...
            >
              <div className="flex">
                <span className="truncate font-normal group-data-[selected]:font-semibold">{country.countryName}</span>
                <span className="ml-2 truncate text-gray-500 group-data-[focus]:text-indigo-200">
                  {country.proxiesCount}
                </span>
              </div>
