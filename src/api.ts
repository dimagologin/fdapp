...
export const getCountries = async ({ proxyType = "mobile", } = { proxyType: "mobile" }) => {
...
export const generateSingleProxy = async ({ countryCode = "DE", proxyType = "mobile" }: { countryCode?: string, proxyType?: string }) => {
  ...
  const exampleReply = {
    ...
    "change_ip_link": "https://api.floppydata.com/v1/proxy/change_ip?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3NTM3NzIwNDYuMjg4MTMyMiwiaWF0IjoxNzIyMjM2MDQ2LjI4ODEzNDgsInVzZXJuYW1lIjoiZU1KaEZpcmlKMHNyUFZmUCJ9.HIuqmij6CcDyDViGhtmrwBWkYexoIMWukWTAJ0Ht0f8"
  }
